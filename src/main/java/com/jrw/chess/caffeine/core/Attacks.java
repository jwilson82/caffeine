...
public class Attacks {
    ...
    public long diagonal(final int square, final long blockers) {
        final int index = transform(blockers & BISHOP_MASKS[square], BISHOP_MAGICS[square], BISHOP_SHIFTS[square]);
        return BISHOP_ATTACKS[square][index];
    }

    public long orthogonal(final int square, final long blockers) {
        final int index = transform(blockers & ROOK_MASKS[square], ROOK_MAGICS[square], ROOK_SHIFTS[square]);
